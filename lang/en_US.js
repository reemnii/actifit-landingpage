module.exports = {
  ...
  sting_chat_unavailable: 'Chat is temporarily unavailable. Please try again.',
  sting_chat_key_required: 'Enter your posting key to open chat.',
  sting_chat_posting_key_title: 'Connect posting-key chat',
  sting_chat_posting_key_help: 'Enter your private posting key. It is kept only in memory until you leave or reload this page.',
  sting_chat_connect: 'Connect',
  sting_chat_invalid_posting_key: 'This posting key does not match the logged-in account.',
  ...
  signup: {
	headline: 'Activate your Actifit account — $2',
	...
	desc_part3: ' </span> AFIT tokens credited to your account immediately. The more you activate, the more you earn.</li><li><span class="afit-tokens-earned text-brand"> ',
	...
	desc_part5: '$ activation, your User Rank will stand at 3%. For instance, <span class="afit-tokens-earned text-brand">activating with 100$ will earn you ',
	...
	hero_sub: 'One-time fee · No subscription · AFIT tokens credited instantly',
	fee_card_title: 'What your $2 covers',
	fee_card_item1: 'Activates your Actifit account permanently',
	fee_card_item2: 'Blocks bots and fake accounts — keeps rewards fair for real members',
	fee_card_item3: 'Credits AFIT tokens to your account immediately',
	fee_card_footer: 'No monthly fees. No hidden costs.',
	why_fee_toggle: 'Why is there a fee?',
	why_fee_title: 'Why $2?',
	why_fee_body: 'Actifit rewards real activity with real tokens, which makes the network a target for bots and fake accounts. A small one-time activation fee solves this — it verifies you\'re a real person and keeps the reward pool fair for genuine members. You pay $2 once. You earn for a lifetime.',
	hive_toggle: 'What is Hive? (and why do I need a blockchain account?)',
	hive_title: 'What is Hive?',
	hive_body: 'Hive is the decentralized network that powers Actifit. When you sign up, you get a Hive account that lets you own your fitness data, earn AFIT tokens and post activity securely — with no company in the middle controlling your information. Your account and tokens belong to you, not Actifit. You control your own login keys — keep them safe.',
	step1: 'Account Details',
	step2: 'Activate',
	step3: 'Done',
	faq_title: 'Quick answers',
	faq_q1: 'Is the $2 a subscription?',
	faq_a1: 'No. It\'s a one-time activation fee. You pay once and your account stays active forever.',
	faq_q2: 'Can I pay with a credit card?',
	faq_a2: 'Currently payment is via crypto (HIVE or HBD). Card payment support is on our roadmap.',
	faq_q3: 'What if I already have a Hive account?',
	faq_a3: 'Head to the login page — you don\'t need to pay again.',
	login_cta: 'Already have an account? Log in',
	social_proof: 'Joined by 50,000+ movers worldwide',
	keys_warning: 'Store your password somewhere safe. Your keys are the only way to access your account — they cannot be reset.'
  },
  ...
  usd_amount_invest: 'Activation Amount (USD)',
  min_amount: '(One-time minimum: $_AMNT_ USD in crypto)',
  choose_cryto: 'Choose Payment Crypto (Actual Amount to Send)',
  steem_amount_send: 'STEEM Amount To Send',
  copy_amount: 'Copy Amount',
  matching_rew_afit: "AFIT Tokens You'll Receive",
  ...
  Copy_Memo: 'Copy Memo',
  Copy_Link: 'Copy Link',
  send_process_verf: 'Once you send the funds, click the button below. Keep the page open while we verify your payment and create your account.',
  send_process_promo_verf: 'Please keep the page open till we confirm your account creation.',
  Steem_sent: "I've sent payment — activate my account",
  ...
  Share: 'Share',
  Referrals: 'Referrals',
  My_Referrals: 'My Successful Referrals',
  ...
  referral_free_signup_links_notice: 'Once you have completed 5 rewarded actifit activity reports, you become eligible to claim 5 free referral signup links to share with your friends. After depletion and completion another 5 rewarded activity reports, you can claim again another 5 free signup links.',
  ...
  Referral_Free_Signup_Links: 'Free Signup Links',
  Claimable_free_links: 'claimableFreeAccounts',
  Claim_free_links: 'Claim Links',
  Claim_links_success: 'Free Signup Links Claimed Successfully!',
  Free_referral_link: 'Free Signup Referral Link _COUNT_',
  ...
  special_halloween_event: 'Halloween Edition!',
  ...
  hidden_low_reputation: 'Comment by {0} hidden due to low reputation',
  Comment: 'Comment',
  Posts: 'Posts',
  admins: 'Admins',
  ...
  proposal_modal_title_year: "Hive Dev Proposal 2026",
  proposal_modal_message: "Support Our partners HDev team's development & growth effort. Vote for their proposal❤️",
...
recent_post:'Recent Posts',
  ...
  adding_meme: 'Adding meme…',
  meme_add_failed: 'Failed to add meme, please try again',
  made_with_decentmemes: 'Made with [decentmemes.com](https://decentmemes.com)',
